...
export class HarmoniaApp extends LitElement {
    ...
    connectedCallback() {
        ...
        if (window.require) {
            ...
            ipcRenderer.on('cultural-coaching', (_, coaching) => {
    ...
    renderCurrentView() {
        ...
        switch (this.currentView) {
            ...
            case 'assistant':
                ...
                if (isCulturalProfile) {
                    return html`
                        <cultural-coaching-view
                            .culturalCoaching=${this.culturalCoaching}
...
customElements.define('harmonia-app', HarmoniaApp);
