        ...
        return [
            {
                ...
                description: 'Real-time cultural intelligence for international business deals',
            },
            {
                value: 'multicultural_team',
                name: '👥 Multicultural Team',
                description: 'Cultural mediation for diverse team meetings',
            },
            {
                value: 'international_sales',
                name: '💼 International Sales',
                description: 'Cultural coaching for global sales conversations',
            },
            {
